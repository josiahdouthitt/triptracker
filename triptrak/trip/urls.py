...
from .views import HomeView, TripCreateView, TripUpdateView, TripDeleteView, NoteCreateView, NoteDetailView, NoteUpdateView, NoteDeleteView, NoteListView, TripDetailView, trips_list
